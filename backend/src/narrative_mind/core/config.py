...
class Settings(BaseSettings):
    ...
    # Graph RAG retrieval: how many entities the vector search seeds with, how
    # many hops the graph expansion walks out from those seeds, and how many
    # entities the serialized context block is capped at. Deliberately no
    # minimum-similarity-score setting — cosine score distributions differ per
    # embedding model, so a threshold tuned against one model is meaningless
    # against another's; rank by top-K instead. See the backend README, "The two
